...
def get_scatter_graph(entered_site, payload_mass):
    ...
    if entered_site == 'All sites':
        fig = px.scatter(spacex_df[filter_mask], x='Payload Mass (kg)', y='class', 
...
# CCAFS LC-40 has 10 successful launches and is the largest successful launches out of all sites.

#2) Which site has the highest launch success rate?
# KSC LC-39A has the hightest launch success rate at 76.9%
...
# B5 booster has 100% launch success rate but it is based on only one launch. 